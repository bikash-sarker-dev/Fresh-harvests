    ...
    <div className="container my-8">
      <div className="flex flex-col md:flex-row   p-6 max-w-4xl mx-auto">
        ...
        <div className="flex-1 mt-6 md:mt-0 md:ml-8">
          ...
          <h2 className="text-5xl font-bold mt-2">Coconut</h2>
          ...
          <p className="text-xl font-semibold text-red-600 mt-3">$6.3/kg</p>

          <p className="text-gray-600 mt-4 text-sm">
            From our farm directly to your door, our fresh coconuts are
            harvested at the peak of ripeness, offering a sweet, hydrating treat
            full of flavor...
          </p>
